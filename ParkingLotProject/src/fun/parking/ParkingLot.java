...
public class ParkingLot {
    ...
    private ParkingLotClass parkingLotClass;
    ...
    public ParkingLot(int capacity) {
        ...
        this.parkingLotClass = ParkingLotClass.REGULAR;
    }

    public ParkingLot(int capacity, ParkingLotClass parkingLotClass) {
        if(capacity <= 0){
            throw new RuntimeException("Capacity should be greater than 0");
        }
        this.capacity = capacity;
        ...
        this.fastFillingThreshold = (int)(FASTFILLINGFACTOR * capacity);
        this.listeners = new HashSet<ParkingLotListener>();
        this.parkingLotClass = parkingLotClass;
    }
    ...
    public ParkingLotClass getParkingLotClass() {
